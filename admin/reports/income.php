        ...
        <div class="scrollit">
            ...
            <tbody>
                    ...
                    <?php foreach ($bookings as $key => $book): ?>
                            ...
                            $result = mysqli_query($db, 'SELECT SUM(price) AS value_sum FROM schedules JOIN bookings ON schedules.schedule_id=bookings.schedule_book_id WHERE bookings.schedule_book_id'); 
                            $row = mysqli_fetch_assoc($result); 
                            $sum = $row['value_sum'];
                            
                            ?>
                            <td style="margin-left: 400px;"><a href="edit.php?id=<?php echo $book['book_id']; ?>" class="btn"><?php echo $sum; ?> </a>
                                   </td>
                                   </tr>
                <!-- </table> -->
            </tbody>
